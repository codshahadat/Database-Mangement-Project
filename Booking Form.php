...
if(isset($savedata))
{
  ...
  else
  {
   ...
   $sql="insert into room_booking_details(name,email,phone,address,contry,room_type,Occupancy,check_in_date,check_in_time,check_out_date) 
     ...
     <form class="form-horizontal" method="post">
       <div class="col-sm-6">
         <div class="form-group">
           <div class="row">
              <div class="control-label col-sm-4"><h4> Name :</h4></div>
                <div class="col-sm-8">
                 <input type="text" value="<?php echo $res['name']; ?>" readonly="readonly" class="form-control" name="name" placeholder="Enter Your Frist Name"required>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
              <input type="email" value="<?php echo $res['email']; ?>" readonly="readonly" class="form-control" name="email"  placeholder="Enter Your Email-Id"required/>
          </div>
        </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
              <input type="number" value="<?php echo $res['mobile']; ?>" readonly="readonly" class="form-control" name="phone" placeholder="Type Your Phone Number"required>
          </div>
        </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
              <textarea name="address" class="form-control" readonly="readonly" placeholder="Enter Your Address"><?php echo $res['address'];  ?></textarea>
          </div>
        </div>
        </div>
         ...
         <div class="form-group">
          ...
          <div class="col-sm-8">
              <input type="text" class="form-control" readonly="readonly"  value="<?php echo $res['country']; ?>" name="country" placeholder="Enter Your Country Name"required>
          </div>
        </div>
        </div>
		<?php
...
?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
              <input type="hidden" name="designup" class="form-control"placeholder="Enter Your State Name"required>
          </div>
        </div>
        </div>
           ...
           <div class="control-label col-sm-4"><h4></h4></div>
          <div class="col-sm-8">
              <input type="hidden" name="designp" class="form-control" placeholder="Enter Your Zip Code"required>
          </div>
        </div>
        </div>
        </div>
                   ...
                   while($res=mysqli_fetch_assoc($sql))
{
                   $oid=$res['rooms'];
?> 
              <option> <?php echo $res['type']?></option>
<?php
}
?>

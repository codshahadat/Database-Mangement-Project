...
if(isset($save))
{
  ...
  {
      $sql="insert into create_account(name,email,password,mobile,address,gender,country,NID) values('$fname','$email','$Passw','$mobi','$addr','$gend','$countr','$NID')";
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-6 ">
       ...
       <div class="form-group">
            <div class="control-label col-sm-5"><h4>NID:</h4></div>
          <div class="col-sm-7">
              <input type="text" name="NID" class="form-control"placeholder="Enter Your National ID"required>
          </div>
        </div>

          <div class="row">
            <div class="col-sm-15"style="text-align:right;"><br>
